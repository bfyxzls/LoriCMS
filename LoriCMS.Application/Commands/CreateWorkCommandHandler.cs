...
namespace LoriCMS.Application.Commands
{
    ...
    /// 建立订单处理程序
    /// </summary>
    public class CreateWorkCommandHandler : IBusHandler<CreateWorkCommand>
    {
        public CreateWorkCommandHandler(IWorkRepository workRepository)
        {
            _workRepository = workRepository;
        }
        public CreateWorkCommandHandler() : this(new WorkRepository())
        {
